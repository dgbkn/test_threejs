      ...
      <group name="Scene">
        ...
        <group name="Holo-Table" position={[-69.434, -10.329, 37.245]} scale={0.114}>
          <group name="Hologram" position={[0, 149.32, 0]} rotation={[-Math.PI / 2, 0.41, 0]} scale={52.304}>
            <mesh name="Hologram_Hologram_0" castShadow receiveShadow geometry={nodes.Hologram_Hologram_0.geometry} material={materials['Hologram.001']} />
          </group>
        </group>
        ...
        <mesh name="Ecran1_Objet2_0" emissiveIntensity={200} toneMapped={false} castShadow receiveShadow geometry={nodes.Ecran1_Objet2_0.geometry} material={materials.Objet2} position={[2052.446, 377.388, -5623.456]} scale={[1.835, 1.888, 1.888]} />
        ...
        <mesh name="room_room_0" material-color={"grey"} luminanceThreshold castShadow receiveShadow geometry={nodes.room_room_0.geometry} material={materials.room} position={[-25.535, -16.148, -1.11]} rotation={[Math.PI / 2, 0, 0]} scale={[0.35, 0.434, 0.35]} />
        ...
        <mesh name="room_view_0" castShadow receiveShadow geometry={nodes.room_view_0.geometry} material={materials.view} position={[-25.535, -28.277, -1.11]} rotation={[Math.PI / 2, 0, 0]} scale={[0.355, 0.453, 0.415]} />
        <mesh name="Table_Table_0" castShadow receiveShadow geometry={nodes.Table_Table_0.geometry} material={materials['Table.001']} position={[-69.434, -4.02, 37.245]} rotation={[-Math.PI / 2, 0, 0]} scale={3.461} />
      </group>
    </group>
  )
}
