      ...
      <group name="Scene">
        ...
        <group name="Holo-Table" position={[-69.434, -10.329, 37.245]} scale={0.114}>
          <group name="Hologram" position={[0, 149.32, 0]} rotation={[-Math.PI / 2, 0.41, 0]} scale={52.304}>
            <mesh name="Hologram_Hologram_0" castShadow receiveShadow geometry={nodes.Hologram_Hologram_0.geometry} material={materials['Hologram.001']} position={[-0.427, 0.718, 1.921]} scale={3.106} />
          </group>
        </group>
        ...
        <mesh name="Table_Table_0" castShadow receiveShadow geometry={nodes.Table_Table_0.geometry} material={materials['Table.001']} position={[-69.434, -4.02, 37.245]} rotation={[-Math.PI / 2, 0, 0]} scale={5.266} />
      </group>
    </group>
  )
}
