  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh material-depthTest={false} renderOrder={1} name="Cart001_Cart_Cover_0" castShadow receiveShadow geometry={nodes.Cart001_Cart_Cover_0.geometry} material={materials.Cart_Cover} position={[-0.59, 0.824, -0.983]} rotation={[0, Math.PI / 6, 0]} scale={1.031} />
